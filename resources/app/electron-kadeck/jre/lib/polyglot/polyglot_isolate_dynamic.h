 ...
 */
typedef poly_status (*poly_create_isolate_fn_t)(const poly_isolate_params* params, poly_isolate* isolate, poly_thread* thread);
 ...
 */
typedef poly_status (*poly_attach_thread_fn_t)(poly_isolate isolate, poly_thread* thread);
 ...
 */
typedef poly_thread (*poly_get_current_thread_fn_t)(poly_isolate isolate);
 ...
 * instead.
 */
typedef poly_isolate (*poly_get_isolate_fn_t)(poly_thread thread);
 ...
 */
typedef poly_status (*poly_detach_thread_fn_t)(poly_thread thread);
 ...
 * Returns poly_ok on success, or poly_generic_failure on failure.
 */
typedef poly_status (*poly_detach_all_threads_and_tear_down_isolate_fn_t)(poly_thread thread);
 ...
 * Returns poly_ok on success, or poly_generic_failure on failure.
 */
typedef poly_status (*poly_tear_down_isolate_fn_t)(poly_thread thread);
