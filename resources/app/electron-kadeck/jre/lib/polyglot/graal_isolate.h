 ...
 */
int32_t graal_create_isolate(graal_create_isolate_params_t* params, graal_isolate_t** isolate, graal_isolatethread_t** thread);
 ...
 */
int32_t graal_attach_thread(graal_isolate_t* isolate, graal_isolatethread_t** thread);
 ...
 * Returns 0 on success, or a non-zero value on failure.
 */
int32_t graal_detach_thread(graal_isolatethread_t* thread);
 ...
 * Returns 0 on success, or a non-zero value on failure.
 */
int32_t graal_tear_down_isolate(graal_isolatethread_t* isolateThread);
 ...
 */
int32_t graal_detach_all_threads_and_tear_down_isolate(graal_isolatethread_t* isolateThread);
